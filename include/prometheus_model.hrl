...
%% Generated by gpb_compile version 3.21.2 on {{2016,6,29},{2,55,10}}

-ifndef(prometheus_model).
-define(prometheus_model, true).

-define(prometheus_model_gpb_version, "3.21.2").

-ifndef('BUCKET_PB_H').
-define('BUCKET_PB_H', true).
-record('Bucket',
        {cumulative_count       :: non_neg_integer() | undefined, % = 1, 32 bits
         upper_bound            :: float() | undefined % = 2
        }).
-endif.
...
-record('Quantile',
        {quantile               :: float() | undefined, % = 1
         value                  :: float() | undefined % = 2
        }).
-endif.
