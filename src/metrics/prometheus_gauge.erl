...
set(Table, Registry, Name, LabelValues, Value) ->
  case ets:update_element(Table, {Registry, Name, LabelValues}, {2, Value}) of
    false ->
      {ok, _} = prometheus_metric:check_mf_exists(Registry, prometheus_gauge, Name, LabelValues),
...
reset(Registry, Name, LabelValues) ->
  ok = prometheus_metric:check_mf_exists(Registry, prometheus_gauge, Name, LabelValues),
